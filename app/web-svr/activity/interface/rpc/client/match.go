...
import (
	...
	matmdl "go-gateway/app/web-svr/activity/interface/model/like"
)
...
const (
	...
	_actLikeSetReload  = "RPC.ActSetReload"
)
const (
...
// ActSetReload reload like set likes
func (s *Service) ActSetReload(c context.Context, arg *matmdl.ArgSetReload) (err error) {
	err = s.client.Call(c, _actLikeSetReload, arg, _noArg)
	return
}
