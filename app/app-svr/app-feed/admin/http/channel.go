...
import (
	...
	"go-gateway/app/app-svr/app-feed/admin/model/channel"
	cardmodel "go-gateway/app/app-svr/app-feed/admin/model/channel"
...
func addTab(c *bm.Context) {
	...
	req.Person = name
	req.UID = uid
	if _, _, err = commonSvc.CardPreview(c, common.CardChannelTab, req.TabID); err != nil {
		return
	}
