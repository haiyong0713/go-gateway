...
func (d *Dao) BgmEntrance(c context.Context, aid, cid int64) (res *model.BgmEntranceReply, err error) {
	...
	if err = d.httpR.Get(c, d.c.Host.MusicAPI+_bgmURL, ip, params, &rs); err != nil {
		log.Error("BgmEntrance d.httpR.Get(%s, %s, %v) error(%v)", d.c.Host.Data+_bgmURL, ip, params, err)
		return
	}
	if rs.Code != 0 {
