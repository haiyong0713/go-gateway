...
import (
	...
	match "go-gateway/app/web-svr/activity/interface/service/like"
)
...
// ActSetReload .
func (r *RPC) ActSetReload(c context.Context, a *matmdl.ArgSetReload, res *struct{}) (err error) {
	return r.s.ActSetReload(c, a.Lid)
}
