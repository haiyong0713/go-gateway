...
type SingleInlineBangumiBuilder interface {
	Parent() LargeCoverInlineBuilderFactory
	SetBase(*jsoncard.Base) SingleInlineBangumiBuilder
	SetRcmd(*ai.Item) SingleInlineBangumiBuilder
	SetEpisode(*pgcinline.EpisodeCard) SingleInlineBangumiBuilder
	SetHasLike(map[int64]int8) SingleInlineBangumiBuilder
	SetInline(*Inline) SingleInlineBangumiBuilder
	Build() (*jsoncard.LargeCoverInline, error)
	WithAfter(req ...func(*jsoncard.LargeCoverInline)) SingleInlineBangumiBuilder
}

type v7SingleInlineBangumiBuilder struct {
...
func (b v7SingleInlineBangumiBuilder) Parent() LargeCoverInlineBuilderFactory {
	return b.parent
}

func (b v7SingleInlineBangumiBuilder) SetBase(base *jsoncard.Base) SingleInlineBangumiBuilder {
	b.base = base
	return b
}

func (b v7SingleInlineBangumiBuilder) SetRcmd(in *ai.Item) SingleInlineBangumiBuilder {
	b.rcmd = in
	return b
}

func (b v7SingleInlineBangumiBuilder) SetHasLike(in map[int64]int8) SingleInlineBangumiBuilder {
	b.hasLike = in
	return b
}

func (b v7SingleInlineBangumiBuilder) SetInline(in *Inline) SingleInlineBangumiBuilder {
	b.inline = in
	return b
}

func (b v7SingleInlineBangumiBuilder) SetEpisode(in *pgcinline.EpisodeCard) SingleInlineBangumiBuilder {
	b.episode = in
	return b
}

func (b v7SingleInlineBangumiBuilder) constructThreePointV2(enableSwitchColumn bool) []*jsoncard.ThreePointV2 {
...
func (b v7SingleInlineBangumiBuilder) constructURI(in *pgcinline.EpisodeCard, device cardschema.Device, rcmd *ai.Item) string {
	param := in.Url
	if param == "" {
		plat := device.Plat()
...
func (b v7SingleInlineBangumiBuilder) constructPlayerArgs() *jsoncard.PlayerArgs {
...
func (b v7SingleInlineBangumiBuilder) constructPlayerWidget() *jsoncard.InlinePlayerWidget {
...
func (b v7SingleInlineBangumiBuilder) settingInlineIcon(out *jsoncard.LargeCoverInline) {
	if b.inline != nil {
...
func (b v7SingleInlineBangumiBuilder) Build() (*jsoncard.LargeCoverInline, error) {
	if b.base == nil {
	...
	out := &jsoncard.LargeCoverInline{
		...
		CoverBadgeStyle:              jsonreasonstyle.ConstructReasonStyle(appcardmodel.BgColorRed, b.episode.Season.TypeName),
		CoverBadge:                   b.episode.Season.TypeName,
	...
	if b.rcmd.RcmdReason != nil && b.parent.BuilderContext.FeatureGates().FeatureEnabled(cardschema.FeatureSingleRcmdReason) {
	...
	out.Avatar = avatar
	out.EnableDoubleClickLike = b.rcmd.SingleInlineDbClickLike()
...
func (b v7SingleInlineBangumiBuilder) WithAfter(req ...func(*jsoncard.LargeCoverInline)) SingleInlineBangumiBuilder {
	b.afterFn = append(b.afterFn, req...)
	return b
}

func (b v7SingleInlineBangumiBuilder) constructLikeButton() *jsoncard.LikeButton {
	selected := int8(0)
...
func (b v7SingleInlineBangumiBuilder) constructSquareCover() string {
	if b.episode.GetSeason().GetSquareCover() != "" {
		return b.episode.GetSeason().GetSquareCover()
	}
	return b.episode.GetSeason().GetCover()
}

func (b v7SingleInlineBangumiBuilder) constructThreePointPanelMeta() (*threePointMeta.PanelMeta, bool) {
	const (
...
func (b v7SingleInlineBangumiBuilder) constructSharePlane() *appcardmodel.SharePlane {
	...
	return &appcardmodel.SharePlane{
		...
		ShareFrom:     appcardmodel.SingleInlinePGCShareFrom,
