...
type PlayerSha1 struct {
	...
	PlayerDanmakuSpeed               int64   `json:"player_danmaku_speed,omitempty"`
	...
	PlayerDanmakuSwitch              bool    `json:"player_danmaku_switch,omitempty"`
	PlayerDanmakuSwitchSave          bool    `json:"player_danmaku_switch_save,omitempty"`
	PlayerDanmakuUseDefaultConfig    bool    `json:"player_danmaku_use_default_config,omitempty"`
	PlayerDanmakuAiRecommendedSwitch bool    `json:"player_danmaku_ai_recommended_switch,omitempty"`
	PlayerDanmakuAiRecommendedLevel  int64   `json:"player_danmaku_ai_recommended_level,omitempty"`
}
...
type Player struct {
	...
	PlayerDanmakuSpeed               int64   `json:"player_danmaku_speed"`
	...
	PlayerDanmakuSwitch              bool    `json:"player_danmaku_switch"`
	PlayerDanmakuSwitchSave          bool    `json:"player_danmaku_switch_save"`
	PlayerDanmakuUseDefaultConfig    bool    `json:"player_danmaku_use_default_config"`
	PlayerDanmakuAiRecommendedSwitch bool    `json:"player_danmaku_ai_recommended_switch"`
	PlayerDanmakuAiRecommendedLevel  int64   `json:"player_danmaku_ai_recommended_level"`
}
