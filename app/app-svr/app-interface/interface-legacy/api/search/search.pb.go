...
// source: go-gateway/app/app-svr/app-interface/interface-legacy/api/search/search.proto
...
func (*DefaultWordsReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{0}
}
...
func (*DefaultWordsReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{1}
}
...
func (*SuggestionResult3Req) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{2}
}
...
func (*SuggestionResult3Reply) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{3}
}
...
func (*ResultItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{4}
}
...
func (*NftFaceIcon) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{5}
}
...
func (*OfficialVerify) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{6}
}
...
func (*ReasonStyle) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae83a52381eb670, []int{7}
}
...
func init() {
	proto.RegisterFile("go-gateway/app/app-svr/app-interface/interface-legacy/api/search/search.proto", fileDescriptor_3ae83a52381eb670)
}

var fileDescriptor_3ae83a52381eb670 = []byte{
	...
	,
}
...
var _Search_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "go-gateway/app/app-svr/app-interface/interface-legacy/api/search/search.proto",
}
...
func (m *DefaultWordsReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IsFresh != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.IsFresh))
		i--
		dAtA[i] = 0x50
	}
	if m.An != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.An))
		i--
		dAtA[i] = 0x48
	}
	if len(m.Query) > 0 {
	...
	if len(m.Avid) > 0 {
		i -= len(m.Avid)
		copy(dAtA[i:], m.Avid)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Avid)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.EventId) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.EventId)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Tab) > 0 {
		i -= len(m.Tab)
		copy(dAtA[i:], m.Tab)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Tab)))
		i--
		dAtA[i] = 0x2a
	}
	if m.LessonsMode != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.LessonsMode))
		i--
		dAtA[i] = 0x20
	}
	if m.TeenagersMode != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.TeenagersMode))
		i--
		dAtA[i] = 0x18
	}
	if m.LoginEvent != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.LoginEvent))
		i--
		dAtA[i] = 0x10
	}
	if m.From != 0 {
...
func (m *DefaultWordsReply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Uri) > 0 {
		i -= len(m.Uri)
		copy(dAtA[i:], m.Uri)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Uri)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Goto) > 0 {
		i -= len(m.Goto)
		copy(dAtA[i:], m.Goto)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Goto)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.ExpStr) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.ExpStr)))
		i--
		dAtA[i] = 0x32
	}
	if m.ShowFront != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.ShowFront))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Word) > 0 {
	...
	if len(m.Show) > 0 {
		i -= len(m.Show)
		copy(dAtA[i:], m.Show)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Show)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Param) > 0 {
		i -= len(m.Param)
		copy(dAtA[i:], m.Param)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Param)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Trackid) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Trackid)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SuggestionResult3Req) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Highlight != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Highlight))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Keyword) > 0 {
...
func (m *ResultItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IsSeniorMember != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.IsSeniorMember))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
	...
	if m.FaceNftNew != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.FaceNftNew))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe0
	...
	if len(m.LiveLink) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.LiveLink)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xda
	...
	if m.ModuleId != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.ModuleId))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd0
	...
	if len(m.Styles) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Styles)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xca
	...
	if m.Vote != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Vote))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb8
	...
	if len(m.Label) > 0 {
		i -= len(m.Label)
		copy(dAtA[i:], m.Label)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Label)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xaa
	...
	if len(m.Style) > 0 {
		i -= len(m.Style)
		copy(dAtA[i:], m.Style)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Style)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa2
	...
	if len(m.Area) > 0 {
		i -= len(m.Area)
		copy(dAtA[i:], m.Area)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Area)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
	...
	if len(m.SeasonTypeName) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.SeasonTypeName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	if m.Ptime != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Ptime))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
	...
	if m.Archives != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Archives))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	...
	if m.Level != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Level))
		i--
		dAtA[i] = 0x78
	}
	if m.Fans != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Fans))
		i--
		dAtA[i] = 0x70
	}
	if m.Mid != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Mid))
		i--
		dAtA[i] = 0x68
	}
	if len(m.Param) > 0 {
	...
	if m.TermType != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.TermType))
		i--
		dAtA[i] = 0x40
	}
	if len(m.SugType) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.SugType)))
		i--
		dAtA[i] = 0x3a
	}
	if m.CoverSize != 0 {
	...
	if m.Position != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.Position))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Keyword) > 0 {
	...
	if len(m.From) > 0 {
		i -= len(m.From)
		copy(dAtA[i:], m.From)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.From)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *NftFaceIcon) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ShowStatus != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.ShowStatus))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Icon) > 0 {
		i -= len(m.Icon)
		copy(dAtA[i:], m.Icon)
		i = encodeVarintSearch(dAtA, i, uint64(len(m.Icon)))
		i--
		dAtA[i] = 0x12
	}
	if m.RegionType != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.RegionType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ReasonStyle) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BgStyle != 0 {
		i = encodeVarintSearch(dAtA, i, uint64(m.BgStyle))
		i--
		dAtA[i] = 0x40
	}
	if len(m.BorderColorNight) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.BorderColorNight)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.BorderColor) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.BorderColor)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.BgColorNight) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.BgColorNight)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.BgColor) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.BgColor)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.TextColorNight) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.TextColorNight)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.TextColor) > 0 {
		...
		i = encodeVarintSearch(dAtA, i, uint64(len(m.TextColor)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Text) > 0 {
...
func (m *DefaultWordsReq) Size() (n int) {
	...
	if m.LoginEvent != 0 {
		n += 1 + sovSearch(uint64(m.LoginEvent))
	}
	if m.TeenagersMode != 0 {
		n += 1 + sovSearch(uint64(m.TeenagersMode))
	}
	if m.LessonsMode != 0 {
		n += 1 + sovSearch(uint64(m.LessonsMode))
	}
	l = len(m.Tab)
	if l > 0 {
	...
	if m.An != 0 {
		n += 1 + sovSearch(uint64(m.An))
	}
	if m.IsFresh != 0 {
		n += 1 + sovSearch(uint64(m.IsFresh))
	}
	if m.XXX_unrecognized != nil {
...
func (m *DefaultWordsReply) Size() (n int) {
	...
	if m.ShowFront != 0 {
		n += 1 + sovSearch(uint64(m.ShowFront))
	}
	l = len(m.ExpStr)
	if l > 0 {
		n += 1 + l + sovSearch(uint64(l))
...
func (m *SuggestionResult3Req) Size() (n int) {
	...
	if m.Highlight != 0 {
		n += 1 + sovSearch(uint64(m.Highlight))
	}
	if m.TeenagersMode != 0 {
		n += 1 + sovSearch(uint64(m.TeenagersMode))
	}
...
func (m *ResultItem) Size() (n int) {
	...
	if m.Position != 0 {
		n += 1 + sovSearch(uint64(m.Position))
	}
	l = len(m.Cover)
	if l > 0 {
		n += 1 + l + sovSearch(uint64(l))
	...
	if m.TermType != 0 {
		n += 1 + sovSearch(uint64(m.TermType))
	}
	l = len(m.Goto)
	if l > 0 {
		n += 1 + l + sovSearch(uint64(l))
	...
	if m.Mid != 0 {
		n += 1 + sovSearch(uint64(m.Mid))
	}
	if m.Fans != 0 {
		n += 1 + sovSearch(uint64(m.Fans))
	}
	if m.Level != 0 {
		n += 1 + sovSearch(uint64(m.Level))
	}
	if m.Archives != 0 {
		n += 2 + sovSearch(uint64(m.Archives))
	}
	if m.Ptime != 0 {
		n += 2 + sovSearch(uint64(m.Ptime))
	}
	...
	if m.ModuleId != 0 {
		n += 2 + sovSearch(uint64(m.ModuleId))
	}
	l = len(m.LiveLink)
	if l > 0 {
		n += 2 + l + sovSearch(uint64(l))
	...
	if m.FaceNftNew != 0 {
		n += 2 + sovSearch(uint64(m.FaceNftNew))
	}
	if m.NftFaceIcon != nil {
	...
	if m.IsSeniorMember != 0 {
		n += 2 + sovSearch(uint64(m.IsSeniorMember))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *NftFaceIcon) Size() (n int) {
	...
	_ = l
	if m.RegionType != 0 {
		n += 1 + sovSearch(uint64(m.RegionType))
	}
	l = len(m.Icon)
	if l > 0 {
		n += 1 + l + sovSearch(uint64(l))
	...
	if m.ShowStatus != 0 {
		n += 1 + sovSearch(uint64(m.ShowStatus))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ReasonStyle) Size() (n int) {
	...
	if m.BgStyle != 0 {
		n += 1 + sovSearch(uint64(m.BgStyle))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
