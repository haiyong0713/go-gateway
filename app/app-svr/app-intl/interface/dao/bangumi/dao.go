...
type Dao struct {
	...
	episodegClient  episodegrpc.EpisodeClient
}
...
func New(c *conf.Config) (d *Dao) {
	...
	if d.pgcsearchClient, err = newClient(nil); err != nil {
		panic(fmt.Sprintf("pgcsearch newClient error (%+v)", err))
	}
	if d.episodegClient, err = episodegrpc.NewClient(c.PGCRPC); err != nil {
