...
func TestAddCacheTextOnly(t *testing.T) {
	convey.Convey("AddCacheTextOnly", t, func(ctx convey.C) {
		var (
			c   = context.Background()
			id  = int64(10256)
			mid = int64(55874896)
		...
		ctx.Convey("When everything goes positive", func(ctx convey.C) {
			err := d.AddCacheTextOnly(c, id, val, mid)
			ctx.Convey("Then err should be nil.res should not be nil.", func(ctx convey.C) {
				ctx.So(err, convey.ShouldBeNil)
			})
		})
...
func TestCacheTextOnly(t *testing.T) {
	convey.Convey("CacheTextOnly", t, func(ctx convey.C) {
		var (
			c   = context.Background()
			id  = int64(10256)
			mid = int64(55874897)
		...
		ctx.Convey("When everything goes positive", func(ctx convey.C) {
			res, err := d.CacheTextOnly(c, id, mid)
			ctx.Convey("Then err should be nil.res should not be nil.", func(ctx convey.C) {
				ctx.So(err, convey.ShouldBeNil)
				print(res)
			})
...
func TestAddCacheIPRequestCheck(t *testing.T) {
	convey.Convey("AddCacheIPRequestCheck", t, func(ctx convey.C) {
		var (
			c  = context.Background()
			id = "10.249.68.78"
		)
		ctx.Convey("When everything goes positive", func(ctx convey.C) {
			err := d.AddCacheIPRequestCheck(c, id, 1)
			ctx.Convey("Then err should be nil.res should not be nil.", func(ctx convey.C) {
				ctx.So(err, convey.ShouldBeNil)
			})
		})
...
func TestCacheIPRequestCheck(t *testing.T) {
	convey.Convey("CacheIPRequestCheck", t, func(ctx convey.C) {
		var (
			c  = context.Background()
			id = "10.249.68.78"
		)
		ctx.Convey("When everything goes positive", func(ctx convey.C) {
			res, err := d.CacheIPRequestCheck(c, id)
			ctx.Convey("Then err should be nil.res should not be nil.", func(ctx convey.C) {
				ctx.So(err, convey.ShouldBeNil)
				fmt.Printf("%+v", res)
			})
