...
type ResultRank struct {
	...
	StatisticsType int               `json:"statistics_type"`
	Batch          int               `json:"batch"`
	AddTime        int64             `json:"add_time"`
	IsShow         int               `json:"is_show"`
	List           []*ResultRankList `json:"list"`
}

// ResultRankList ...
type ResultRankList struct {
	OID       int64             `json:"oid"`
	Score     int64             `json:"score"`
	ShowScore string            `json:"show_score"`
	Rank      int64             `json:"rank"`
	AID       []*ResultOidScore `json:"aids"`
}

// ResultOidScore ...
type ResultOidScore struct {
	AID       int64  `json:"aids"`
	Score     int64  `json:"score"`
	ShowScore string `json:"show_score"`
}
...
type ResultList struct {
	StatisticsType int          `form:"statistics_type" json:"statistics_type"`
	ShowBatchTime  int64        `form:"batch_time" json:"batch_time"`
...
type Archive struct {
	...
	Score     int64                       `json:"score"`
	PubDate   go_common_library_time.Time `json:"ctime"`
	ShowScore string                      `json:"show_score"`
...
type Account struct {
	...
	VipInfo  accountapi.VipInfo      `json:"vip_info"`
	Official accountapi.OfficialInfo `json:"official"`
}
