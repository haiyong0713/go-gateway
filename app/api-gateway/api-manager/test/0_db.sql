...
CREATE TABLE `api_list` (
  ...
  `form_body` varchar(4096) NOT NULL DEFAULT '' COMMENT 'form格式的body',
  `json_body` varchar(4096) NOT NULL DEFAULT '' COMMENT 'json格式的body',
  `output` varchar(4096) NOT NULL DEFAULT '' COMMENT '接口输出',
