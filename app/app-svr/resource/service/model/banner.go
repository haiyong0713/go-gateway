...
type Banner struct {
	...
	Weight              int             `json:"-"`
	AsgID               int64           `json:"-"`
	InlineUseSame       int64           `json:"inline_use_same"`
	InlineType          int64           `json:"inline_type"`
	InlineURL           string          `json:"inline_url"`
	InlineBarrageSwitch int64           `json:"inline_barrage_switch"`
	CreativeStyle       int64           `json:"creative_style,omitempty"`
}
...
func (b *Banner) BannerChange() {
	...
	case 3:
		//GotoBangumi
		b.URI = fmt.Sprintf("https://www.bilibili.com/bangumi/play/ep%s?goto=static_banner", b.Value)
	case 5:
		//GotoGame
	...
	case 9:
		// OGV pay
		// TODO use pgc api uri.
		b.URI = "https://m.bilibili.com/cheese/play/ep" + b.Value
	}
}
