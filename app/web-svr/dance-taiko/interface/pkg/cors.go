...
func CORS() blademaster.HandlerFunc {
	config := &CORSConfig{
...
func newCORS(config *CORSConfig) blademaster.HandlerFunc {
...
func (cors *cors) applyCORS(c *blademaster.Context) {
	...
	if !cors.validateOrigin(origin) {
		log.Error("CORS The request's Origin header `%s` does not match any of allowed origins.", origin)
...
func (cors *cors) handlePreflight(c *blademaster.Context) {
	header := c.Writer.Header()
...
func (cors *cors) handleNormal(c *blademaster.Context) {
	header := c.Writer.Header()
