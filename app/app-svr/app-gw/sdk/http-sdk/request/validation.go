...
// OrigErr returns the invalid parameters as a sdkerr.BatchedErrors value
func (e ErrInvalidParams) OrigErr() error {
	return sdkerr.NewBatchError(
...
// OrigErr returns nil, Implemented for sdkerr.Error interface.
