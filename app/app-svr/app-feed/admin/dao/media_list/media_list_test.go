...
func TestMediaListInfo(t *testing.T) {
	convey.Convey("Media List Info", t, func(ctx convey.C) {
		var (
			c = context.Background()
		)
		ctx.Convey("When everything goes positive", func(ctx convey.C) {
			res, err := d.MediaListInfo(c, 123)
		...
		ctx.Convey("When invalid mediaList", func(ctx convey.C) {
			_, err := d.MediaListInfo(c, 1)
