...
func (d *Dao) UserConf(ctx context.Context, mid int64, moduleKey int) (userConf *model.UserConf, err error) {
	row := d.db.QueryRow(ctx, _getUserConf, mid, moduleKey)
...
func (d *Dao) UserConfMaster(ctx context.Context, mid int64, moduleKey int) (userConf *model.UserConf, err error) {
