...
func Test_RPC(t *testing.T) {
	Convey("RPC Region Archives", t, func() {
		...
		testRPCRegionArcs(client)
		testRPCRegionTagArcs(client)
		testRPCRegionsArcs(client)
		testRPCRegionTotal(client)
	})
}

func testRPCRegionArcs(client *rpc.Client) {
	var (
		rid    int32 = 168
		pn, ps       = 1, 10
		ip           = "127.0.0.1"
...
func testRPCRegionTagArcs(client *rpc.Client) {
	var (
		rid    int32 = 168
		tid    int64 = 123456
		pn, ps       = 1, 10
...
func testRPCRegionsArcs(client *rpc.Client) {
	var (
...
func testRPCRegionTotal(client *rpc.Client) {
	var (
		ip  = "127.0.0.1"
		res map[string]int
	)
