...
import (
	...
	dao "go-gateway/app/web-svr/activity/interface/dao/springfestival2021"
...
type Service struct {
	...
	allTask        []*sfmdl.Task
	followMid      []*sfmdl.FollowMid
	ogvLink        []*sfmdl.OgvLink
...
func New(c *conf.Config) (s *Service) {
	s = &Service{
		...
		cache:          fanout.New("springfestival2021", fanout.Worker(1), fanout.Buffer(1024)),
	}
