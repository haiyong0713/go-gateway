...
import (
	...
	reportdao "go-gateway/app/app-svr/app-view/interface/dao/report"
	"go-gateway/app/app-svr/app-view/interface/model"
	"go-gateway/app/app-svr/app-view/interface/model/elec"
	"go-gateway/app/app-svr/app-view/interface/model/report"
...
func (s *Service) CopyWriter(c context.Context, aid int64, plat int8, lang string) (cps []report.CopyWriter, err error) {
	...
	// check elec
	var info *elec.Info
	if _, ok := s.allowTypeIds[int16(a.TypeId)]; ok && a.IsNormal() && a.Copyright == int32(api.CopyrightOriginal) {
		if info, err = s.elcDao.Info(c, a.Mid, 0); err != nil {
			return
		}
	}
	if info != nil {
