...
func helpList(c *bm.Context) {
	...
	if rs, err = webSvc.HelpList(c, v.PTypeID, v.Version); err != nil {
...
func helpDetail(c *bm.Context) {
	...
	if detail, list, total, err = webSvc.HelpDetail(c, v.FID, v.PTypeID, v.KeyFlag, v.Pn, v.Ps, v.Version); err != nil {
		c.JSON(nil, ecode.Degrade)
...
func helpSearch(c *bm.Context) {
	...
	if list, total, err = webSvc.HelpSearch(c, v.PTypeID, v.KeyWords, v.KeyFlag, v.Pn, v.Ps, v.Version); err != nil {
		c.JSON(nil, err)
