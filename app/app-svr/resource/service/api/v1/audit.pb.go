...
func (m *Audit) GetMobiApp() string {
	if m != nil {
		return m.MobiApp
	}
	return ""
...
type AuditReply struct {
	List                 []*Audit `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *AuditReply) Reset()         { *m = AuditReply{} }
func (m *AuditReply) String() string { return proto.CompactTextString(m) }
func (*AuditReply) ProtoMessage()    {}
func (*AuditReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_5594839dd8e38a1b, []int{1}
}
func (m *AuditReply) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AuditReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AuditReply.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AuditReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AuditReply.Merge(m, src)
}
func (m *AuditReply) XXX_Size() int {
	return m.Size()
}
func (m *AuditReply) XXX_DiscardUnknown() {
	xxx_messageInfo_AuditReply.DiscardUnknown(m)
}

var xxx_messageInfo_AuditReply proto.InternalMessageInfo

func (m *AuditReply) GetList() []*Audit {
	if m != nil {
		return m.List
	}
	return nil
...
func init() {
	proto.RegisterType((*Audit)(nil), "resource.service.v1.Audit")
	proto.RegisterType((*AuditReply)(nil), "resource.service.v1.AuditReply")
}
...
var fileDescriptor_5594839dd8e38a1b = []byte{
	...
	,
}
...
func (m *Audit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Build != 0 {
		i = encodeVarintAudit(dAtA, i, uint64(m.Build))
		i--
		dAtA[i] = 0x10
	}
	if len(m.MobiApp) > 0 {
		...
		i = encodeVarintAudit(dAtA, i, uint64(len(m.MobiApp)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *AuditReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AuditReply) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AuditReply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AuditReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AuditReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AuditReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
