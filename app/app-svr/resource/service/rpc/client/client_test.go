...
// testPlayerIcon2 test rpc play icon 2.
func testPlayerIcon2(t *testing.T, s *Service) {
	ab := &model.ArgPlayIcon{
		Aid: 10111165,
	}
	res, err := s.PlayerIcon2(context.TODO(), ab)
	if err != nil {
		t.Logf("PlayerIcon2 error(%v) \n", err)
		return
	}
	t.Logf("PlayerIcon2 res: %+v \n", res)
}
