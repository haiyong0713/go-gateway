...
func TestStatusByMid(t *testing.T) {
	convey.Convey("StatusByMid", t, func(convCtx convey.C) {
		var (
			c = context.Background()
		)
		convCtx.Convey("When everything goes positive", func(convCtx convey.C) {
			p1, err := d.StatusByMid(c, 15555181, []int32{33959, 33958})
...
func TestAddFollow(t *testing.T) {
	convey.Convey("AddFollow", t, func(convCtx convey.C) {
		var (
			c = context.Background()
		)
		convCtx.Convey("When everything goes positive", func(convCtx convey.C) {
			err := d.AddFollow(c, 33959, 15555181)
			convCtx.Convey("Then err should be nil.p1 should not be nil.", func(convCtx convey.C) {
				convCtx.So(err, convey.ShouldBeNil)
			})
		})
...
func TestDeleteFollow(t *testing.T) {
	convey.Convey("DeleteFollow", t, func(convCtx convey.C) {
		var (
			c = context.Background()
		)
		convCtx.Convey("When everything goes positive", func(convCtx convey.C) {
			err := d.DeleteFollow(c, 33959, 15555181)
			convCtx.Convey("Then err should be nil.p1 should not be nil.", func(convCtx convey.C) {
				convCtx.So(err, convey.ShouldBeNil)
			})
		})
