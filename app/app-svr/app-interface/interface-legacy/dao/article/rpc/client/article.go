...
import (
	...
	"go-gateway/app/app-svr/app-interface/interface-legacy/dao/article/model"
...
type ArticleRPC interface {
	...
	CategoriesMap(c context.Context, arg *model.ArgIP) (res map[int64]*article.Category, err error)
...
func (s *Service) CategoriesMap(c context.Context, arg *model.ArgIP) (res map[int64]*article.Category, err error) {
