...
func TestDao_DynamicList(t *testing.T) {
	convey.Convey("test dynamic list", t, func(ctx convey.C) {
		defer gock.OffAll()
		httpMock("GET", d.dynamicListURL).Reply(200).JSON(`{"code":0,"msg":"","message":"","data":{"items":[{"uid":2089809,"num":345}],"_gt_":0}}`)
		mid := int64(29313802)
		vmid := int64(34709144)
...
func TestDao_Dynamic(t *testing.T) {
	convey.Convey("test dynamic item", t, func(ctx convey.C) {
		defer gock.OffAll()
		httpMock("GET", d.dynamicURL).Reply(200).JSON(`{"code":0,"msg":"","message":"","data":{"items":[{"uid":2089809,"num":345}],"_gt_":0}}`)
		mid := int64(27515256)
