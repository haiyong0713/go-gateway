...
import (
	...
	"go-gateway/app/app-svr/app-interface/interface-legacy/model/pay"

	"github.com/pkg/errors"
)

const (
	_wallet = "/payplatform/cashier/wallet-int/getUserWalletInfo"
)
...
func New(c *conf.Config) (d *Dao) {
	d = &Dao{
		...
		wallet: c.HostDiscovery.Pay + _wallet,
	}
	return
}
