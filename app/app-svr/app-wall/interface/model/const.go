...
const (
	...
	ConsumeIntegral = ConsumeKind("integral")
	ConsumeFlow     = ConsumeKind("flow")

	ActionIntegralPack = Action("integral_pack")
	ActionFlowPack     = Action("flow_pack")
)
...
var (
	ChannelGdt = map[string]*GdtKey{
		"1439767": {Encrypt: "BAAAAAAAAAAAFfgX", Sign: "ee358e8dccbbc4ba"},
		"406965":  {Encrypt: "BAAAAAAAAAAABjW1", Sign: "a45cbd2d4c5344b3"},
		"7799673": {Encrypt: "BAAAAAAAAAAAdwN5", Sign: "54b6deffcd64b6b0"},
	}
