...
// FromInfo .
func (v *Dimension) FromInfo(in *DimensionInfo) {
	v.Rotate = 0
	v.Width = in.Width
	v.Height = in.Height
	v.Sar = in.Sar
...
// DimensionInfo is the structure of reply about the dimension got from BVC's api
...
// IsVertical .
func (v *DimensionInfo) IsVertical() bool {
...
type DimensionReply struct {
	...
	Info    []*DimensionInfo `json:"info"`
}

type DimensionsReply struct {
	Code    int                        `json:"code"`
	Message string                     `json:"message"`
	Info    map[int64][]*DimensionInfo `json:"info"`
}
