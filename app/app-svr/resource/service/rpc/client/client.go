...
const (
	...
	_playerIcon2              = "RPC.PlayerIcon2"
	_customConfig             = "RPC.CustomConfig"
	_getPlayerCustomizedPanel = "RPC.GetPlayerCustomizedPanel"
...
// PlayerIcon2 get palyer config.
func (s *Service) PlayerIcon2(c context.Context, arg *model.ArgPlayIcon) (res *model.PlayerIcon, err error) {
	res = new(model.PlayerIcon)
	err = s.client.Call(c, _playerIcon2, arg, res)
	return
}
...
// CustomConfig is
func (s *Service) CustomConfig(ctx context.Context, req *pb.CustomConfigRequest) (*pb.CustomConfigReply, error) {
	reply := &pb.CustomConfigReply{}
	if err := s.client.Call(ctx, _customConfig, req, &reply); err != nil {
		return nil, err
	}
	return reply, nil
}

func (s *Service) GetPlayerCustomizedPanel(ctx context.Context, req *pb.GetPlayerCustomizedPanelReq) (*pb.GetPlayerCustomizedPanelRep, error) {
	reply := &pb.GetPlayerCustomizedPanelRep{}
	if err := s.client.Call(ctx, _getPlayerCustomizedPanel, req, &reply); err != nil {
		return nil, err
	}
	return reply, nil
}
