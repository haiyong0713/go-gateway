...
func (ts *Taishan) NewPutReq(key, value []byte) *taishan.PutReq {
	req := &taishan.PutReq{
		Table: ts.tableCfg.Table,
		Auth: &taishan.Auth{
			Token: ts.tableCfg.Token,
...
func (ts *Taishan) NewBatchPutReq(ctx context.Context, keys map[string][]byte) *taishan.BatchPutReq {
